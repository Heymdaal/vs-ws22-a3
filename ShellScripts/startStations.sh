...
########################################################################################################
stationCmd="/usr/lib/jvm/java-1.11.0-openjdk-amd64/bin/java -Dfile.encoding=UTF-8 -classpath /home/networker/vs-ws22/aufg3/target/classes org.example.Main $interfaceName $mcastAddress $receivePort $stationClass $UTCoffsetMs"
